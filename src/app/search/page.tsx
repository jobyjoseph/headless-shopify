...
export default function SearchPage() {
  // TODO: Get search query from URL params and fetch results from Shopify API
  const searchResults = placeholderSearchResults;
  ...
  return (
    <main className="px-5 py-8 lg:px-10 lg:py-12">
      ...
      <div className="pb-6 mb-8 text-center">
        ...
        <p className="text-gray-900">{searchResults.resultsCount} results</p>
      </div>
